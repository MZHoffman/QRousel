...
export function useQrCodeLibrary(user: User, workspaceId: string) {
  ...
  async function create(input: { name: string; kind: QrCodeKind; value: string; color: string; version: number; iconId: string | null }) {
  ...
  async function update(code: typeof codes[number], input: { name: string; kind: QrCodeKind; value: string; color: string; version: number; iconId: string | null }) {
