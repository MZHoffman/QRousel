...
type Presentation = { deck: { id: string; name: string; defaultDisplayDurationSeconds: number }; slides: { id: string; title: string; description: string; displayDurationSeconds: number | null; qrCode: { content: string; color: string; version: number; iconImage: string | null } | null }[] };
