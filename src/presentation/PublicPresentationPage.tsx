...
type Presentation = { deck: { id: string; name: string; defaultDisplayDurationSeconds: number }; slides: { id: string; title: string; description: string; displayDurationSeconds: number | null; qrCode: { id: string; content: string; kind: "url" | "email" | "phone" | "wifi" | "text"; color: string; version: number; iconImage: string | null } | null }[] };
